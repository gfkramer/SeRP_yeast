...
comparing two biological replicates of total and selective ribosome profiling
samples. 
...
number of samples with 'included' tag 
...
'''
>> to run this script via IDLE or another environment replace lines 109-127 by 

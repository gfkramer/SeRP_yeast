...
if __name__ == '__main__':
    ...
    p.add_argument('threshold', type=float, help = 'minimal number of footprints per transcript to be included in further analysis')
...
'''
>> to run this script via IDLE or another environment replace lines 239-260 by 
